...
preflight(){
    output "Pterodactyl Instalaçao Né kkk"
    output "Copyright © 2022 ArthurZinMaker"
    output ""
    ...
    if [ "$EUID" -ne 0 ]; then
        output "Da um Sudo su ou root ae"
        exit 3
    fi
